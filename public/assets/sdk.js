...
!1;soundManager.useHTML5Audio=!1;soundManager.beginDelayedInit();return soundManager.onready(function(){return a()})}))},stream:function(a,b){b==null&&(b={});return SC.whenStreamingReady(function(){var c;b.id="T"+a;b.url="http://"+SC.hostname("api")+"/tracks/"+a+"/stream?client_id=YOUR_CLIENT_ID";if(!(c=soundManager.getSoundById(b.id)))c=soundManager.createSound(b);return c})},whenXDMReady:function(a){return window.crossdomain!=null?a():(window.CROSSDOMAINJS_PATH="http://"+this.hostname("connect")+
"/crossdomain-requests-js",SC.Helper.loadJavascript(CROSSDOMAINJS_PATH+"/crossdomain-ajax.js",function(){return a()}))},request:function(a,b,c,d){var e,g,f;d==null&&(d=c,c=void 0);c||(c={});f=SC.prepareRequestURI(b,c);f.query.format="json";SC.options.flashXHR&&SC.Helper.setFlashStatusCodeMaps(f.query);if(a==="PUT"||a==="DELETE")f.query._method=a,a="POST";if(a!=="GET")e=f.encodeParams(f.query),f.query={};g=function(a,b){var c;c=SC.Helper.responseHandler(a,b);return d(c.json,c.error)};return SC.options.flashXHR?
this.whenRecordingReady(function(){return Recorder.request(a,f.toString(),e,g)}):this._request(a,f.toString(),e,g)},_request:function(a,b,c,d){var e;e=new XMLHttpRequest;e.open(a,b.toString(),!0);e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.onreadystatechange=function(a){if(a.target.readyState===4)return d(a.target.responseText,a.target)};return e.send(c)},post:function(a,b,c){return this.request("POST",a,b,c)},put:function(a,b,c){return this.request("PUT",a,b,c)},get:function(a,
b,c){return this.request("GET",a,b,c)},"delete":function(a,b){return this.request("DELETE",a,{},b)},prepareRequestURI:function(a,b){var c,d,e;b==null&&(b={});d=new SC.URI(a,{decodeQuery:!0});for(c in b)__hasProp.call(b,c)&&(e=b[c],d.query[c]=e);if(d.isRelative())d.host=this.hostname("api"),d.scheme="http";this.accessToken()!=null?(d.query.oauth_token=this.accessToken(),d.scheme="https"):d.query.client_id=this.options.client_id;return d},oEmbed:function(a,b,c){var d;c==null&&(c=b,b=void 0);b||(b={});
b.url=a;a=new SC.URI("http://"+SC.hostname("api")+"/oembed");a.query=b;c.nodeType!==void 0&&c.nodeType===1&&(d=c,c=__bind(function(a){return d.innerHTML=a.html},this));return SC.Helper.JSONP.get(a,c)},storage:function(){return window.localStorage||(this._fakeStorage=new SC.Helper.FakeStorage)},whenRecordingReady:function(a){return window.Recorder.flashInterface()&&window.Recorder.flashInterface().record!=null?a():Recorder.initialize({swfSrc:"http://"+this.hostname("connect")+"/recorder.js/recorder.swf",
initialized:function(){return a()}})},record:function(a){a==null&&(a={});return this.whenRecordingReady(function(){return Recorder.record(a)})},recordStop:function(){return Recorder.stop()},recordPlay:function(a){a==null&&(a={});return Recorder.play(a)},recordUpload:function(a,b){var c;a==null&&(a={});c=SC.prepareRequestURI("/tracks",a);c.query.format="json";SC.Helper.setFlashStatusCodeMaps(c.query);c=c.flattenParams(c.query);return Recorder.upload({method:"POST",url:"https://"+this.hostname("api")+
"/tracks.json?oauth_token=1-12885-8716802-2cb07260d4801038",audioParam:"track[asset_data]",params:c,success:function(a){a=SC.Helper.responseHandler(a);return b(a.json,a.error)}})},Helper:{loadJavascript:function(a,b){var c;c=document.createElement("script");c.async=!0;c.src=a;SC.Helper.attachEvent(c,"load",b);document.body.appendChild(c);return c},openCenteredPopup:function(a,b,c){var d,e,b={location:1,width:b,height:c,left:window.screenX+(window.outerWidth-b)/2,top:window.screenY+(window.outerHeight-c)/2,toolbar:"no",scrollbars:"yes"},c=[];for(d in b)__hasProp.call(b,
d)&&(e=b[d],c.push(d+"="+e));return window.open(a,"connectWithSoundCloud",c.join(", "))},attachEvent:function(a,b,c){return a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,c,!1)},millisecondsToHMS:function(a){var b,c,d,a={h:Math.floor(a/36E5),m:Math.floor(a/6E4%60),s:Math.floor(a/1E3%60)};d=[];a.h>0&&d.push(a.h);c=b="";a.m<10&&a.h>0&&(b="0");a.s<10&&(c="0");d.push(b+a.m);d.push(c+a.s);return d.join(".")},setFlashStatusCodeMaps:function(a){a["_status_code_map[400]"]=200;a["_status_code_map[401]"]=
200;a["_status_code_map[403]"]=200;a["_status_code_map[404]"]=200;a["_status_code_map[422]"]=200;a["_status_code_map[500]"]=200;a["_status_code_map[503]"]=200;return a["_status_code_map[504]"]=200},responseHandler:function(a,b){var c,d;d=SC.Helper.JSON.parse(a);c=null;d?d.errors&&(c={message:d.errors&&d.errors[0].error_message}):c=b?{message:"HTTP Error: "+b.status}:{message:"Unknown error"};return{json:d,error:c}},FakeStorage:function(){return{_store:{},getItem:function(a){return this._store[a]||
null},setItem:function(a,b){return this._store[a]=b.toString()},removeItem:function(){return delete this._store.key}}},JSON:{parse:function(a){return a[0]!=="{"&&a[0]!=="["?null:window.JSON!=null?window.JSON.parse(a):eval(a)}},JSONP:{callbacks:{},randomCallbackName:function(){return"CB"+parseInt(Math.random()*999999,10)},get:function(a,b){var c;c=this.randomCallbackName();a.query.format="js";a.query.callback="SC.Helper.JSONP.callbacks."+c;SC.Helper.JSONP.callbacks[c]=b;return SC.Helper.loadJavascript(a.toString(),
function(){return document.body.removeChild(this)})}}}});
var Recorder = {
